...
if st.button("Predict"):
    ...
    input_data_dict = {
        ...
        "CD_CREDIT_RATING_HIGHRISK": 0.0,
        "CD_CREDIT_RATING_LOWRISK": 0.0,
        "CD_EDUCATION_STATUS_2YRDEGREE": 0.0,
        "CD_EDUCATION_STATUS_4YRDEGREE": 0.0,
        "CD_EDUCATION_STATUS_ADVANCEDDEGREE": 0.0,
